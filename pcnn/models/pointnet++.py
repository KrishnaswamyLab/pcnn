...
class Pointnet_plus(pl.LightningModule):
    def __init__(self, input_dim, num_classes,lr, **kwargs):
        super().__init__()
        self.lr = lr
        # Input channels account for both `pos` and node features.
        self.sa1_module = SAModule(0.5, 0.2, MLP([2*input_dim, 64, 64, 128]))
        self.sa2_module = SAModule(0.25, 0.4, MLP([128 + input_dim, 128, 128, 256]))
        self.sa3_module = GlobalSAModule(MLP([256 + input_dim, 256, 512, 1024]))
